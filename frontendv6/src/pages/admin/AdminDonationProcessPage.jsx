...
const AdminDonationProcessPage = () => {
  ...
  const handleSubmit = async (submitType) => {
    ...
    switch (submitType) {
      ...
      case 'healthCheck':
        success = await recordHealthCheck(selectedProcess.id, forms.healthCheckForm);
        break;
        
      case 'collection':
        success = await markBloodAsCollected(selectedProcess.id, forms.collectionForm);
        break;
        
      case 'testResult':
        success = await recordTestResult(selectedProcess.id, forms.testResultForm);
        break;
