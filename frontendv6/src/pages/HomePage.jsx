          ...
          <PageContainer>
            <div className='text-center mb-12'>
              ...
              <p className='text-body-large max-w-2xl mx-auto'>
                Chọn hành động phù hợp với bạn để tham gia vào cộng đồng hiến
                máu.
              </p>
            </div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
              <Card hover className='text-center group'>
                <CardContent className='p-8'>
                  ...
                  <p className='text-gray-600 mb-6'>
                    Chọn thời gian và địa điểm phù hợp để hiến máu
                  </p>
              ...
              <Card hover className='text-center group'>
                <CardContent className='p-8'>
                  ...
                  <p className='text-gray-600 mb-6'>
                    Xem các yêu cầu máu khẩn cấp trong khu vực
                  </p>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-8 text-center'>
              {stats.map((stat, index) => (
                ...
                >                  <div className='mb-4'>
                  ...
                  </div>                  <div className='text-4xl lg:text-5xl font-bold mb-2 animate-pulse-soft'>
                    {stat.number}
                  </div>
