...
const Button = ({
    ...
    const variantStyles = {
        ...
        icon: 'text-gray-500 hover:text-red-600 hover:bg-red-100 focus:ring-red-500 disabled:text-gray-300 disabled:hover:bg-transparent p-0', // Changed p-0.5 to p-0
