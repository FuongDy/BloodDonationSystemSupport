        ...
        <div className="space-y-4">
          <div>
            ...
            <select
              ...
              onChange={(e) => onFormChange('status', 'newStatus', e.target.value)}
              className="w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-red-500"
            >
              <option value="">Chọn trạng thái</option>
              <option value={DONATION_STATUS.APPOINTMENT_PENDING}>Chờ đặt lịch hẹn</option>
          ...
          <div className="flex justify-end space-x-2">
            ...
            <Button onClick={() => onSubmit('status')}>
              Cập nhật
            </Button>
          </div>
        </div>
      ...
      >
        <div className="space-y-4">
          <InputField
            ...
            onChange={(e) => onFormChange('appointment', 'appointmentDateTime', e.target.value)}
          />
          <InputField
            label="Địa điểm"
            value={appointmentForm.location}
            onChange={(e) => onFormChange('appointment', 'location', e.target.value)}
          ...
          />
          <div className="flex justify-end space-x-2">
            <Button variant="outline" onClick={() => onModalClose('appointment')}>
              Hủy
            </Button>
