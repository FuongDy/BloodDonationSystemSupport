...
const BloodTypeDistributionCard = ({
  ...
  >
    <div className='flex items-center justify-between mb-3'>
      <p className={`text-2xl font-bold ${isRare ? 'text-red-700' : 'text-blue-700'}`}>
        {type}
      </p>
      <Droplets className={`w-6 h-6 ${isRare ? 'text-red-500' : 'text-blue-500'} group-hover:animate-pulse`} />
    </div>
    <p className={`text-4xl font-bold ${isRare ? 'text-red-600' : 'text-blue-600'} mb-2`}>
      {percentage}
    </p>
    ...
    <div className='animate-fade-in space-y-12'>
      ...
      <div className='text-center'>
        ...
        <p className='text-lg text-gray-600 max-w-3xl mx-auto'>
          Hiểu rõ về các nhóm máu khác nhau và sự phân bố của chúng trong dân số để trở thành người hiến máu hiệu quả
        </p>
      </div>
        ...
        <div className='space-y-6'>
          <div className='bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-2xl border border-blue-200'>
            <div className='flex items-center mb-4'>
              ...
              <h3 className='text-xl font-semibold text-blue-800 ml-3'>Hệ thống nhóm máu ABO</h3>
            </div>
            <p className='text-gray-700 leading-relaxed'>
              Hệ thống ABO phân loại máu thành bốn loại chính: A, B, AB và O, 
              dựa trên sự hiện diện hoặc vắng mặt của kháng nguyên A và B trên bề mặt hồng cầu.
            </p>
          </div>
          ...
          <div className='bg-gradient-to-r from-red-50 to-pink-50 p-6 rounded-2xl border border-red-200'>
            <div className='flex items-center mb-4'>
              ...
              <h3 className='text-xl font-semibold text-red-800 ml-3'>Yếu tố Rh</h3>
            </div>
            <p className='text-gray-700 leading-relaxed'>
              Yếu tố Rh là một kháng nguyên quan trọng khác trên hồng cầu. 
              Nếu có mặt, nhóm máu là dương (+); nếu không có, là âm (-).
            </p>
          </div>
        </div>
        ...
        <div className='grid lg:grid-cols-3 gap-6'>
          <div className='text-center'>
            ...
            <p className='text-gray-600 text-sm'>
              Chỉ chiếm 7% dân số nhưng có thể cứu sống bất kỳ ai trong tình huống khẩn cấp
            </p>
          </div>
          <div className='text-center'>
            ...
            <p className='text-gray-600 text-sm'>
              Có thể nhận máu từ tất cả các nhóm máu khác, được gọi là "người nhận toàn năng"
            </p>
          </div>
          <div className='text-center'>
        ...
        <div className='relative container mx-auto px-4 py-16 lg:py-20'>
          <div className='text-center max-w-4xl mx-auto'>
            ...
            <p className='text-xl lg:text-2xl text-red-100 mb-8 font-light max-w-3xl mx-auto'>
              Khám phá thế giới tương thích nhóm máu và trở thành người hùng cứu người với kiến thức chuyên sâu
            </p>
          ...
          <div className='flex flex-col lg:flex-row gap-4 lg:gap-6 mb-12'>
            ...
            >
              <div className='flex items-center justify-center mb-3'>
                <Info className={`w-8 h-8 ${activeTab === 'types' ? 'text-white' : 'text-blue-600'}`} />
              </div>
              <h3 className='text-lg font-semibold mb-2'>Nhóm Máu</h3>
              <p className={`text-sm ${activeTab === 'types' ? 'text-blue-100' : 'text-gray-600'}`}>
            ...
            >
              <div className='flex items-center justify-center mb-3'>
                <ArrowRightLeft className={`w-8 h-8 ${activeTab === 'compatibility' ? 'text-white' : 'text-red-600'}`} />
              </div>
              <h3 className='text-lg font-semibold mb-2'>Tương Thích</h3>
              <p className={`text-sm ${activeTab === 'compatibility' ? 'text-red-100' : 'text-gray-600'}`}>
            ...
            >
              <div className='flex items-center justify-center mb-3'>
                <Activity className={`w-8 h-8 ${activeTab === 'process' ? 'text-white' : 'text-green-600'}`} />
              </div>
              <h3 className='text-lg font-semibold mb-2'>Quy Trình</h3>
              <p className={`text-sm ${activeTab === 'process' ? 'text-green-100' : 'text-gray-600'}`}>
