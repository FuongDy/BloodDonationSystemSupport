    ...
    <div className='p-6'>
      ...
      <div className='mb-4'>
        <SearchBar
          ...
          placeholder='Tìm kiếm theo ID, họ tên hoặc email...'
        />
      </div>
          ...
          {usersPage.totalPages > 1 && (
            <div className='mt-6 flex flex-col sm:flex-row justify-between items-center gap-4'>
              <div className='text-sm text-gray-700'>
                Trang{' '}
                <span className='font-medium'>{usersPage.number + 1}</span> /{' '}
                <span className='font-medium'>{usersPage.totalPages}</span> (
                {usersPage.totalElements} kết quả)
              </div>
              <Pagination
