  ...
  const footerData = useMemo(
    () => ({
      company: {
        name: 'HiBlood',
        description:
          'Hệ thống quản lý hiến máu giúp kết nối người hiến máu và những người cần máu, góp phần cứu sống nhiều sinh mạng quý báu.',
      },
      quickLinks: [
          ...
          <div className='col-span-1 md:col-span-2'>
            <div className='bg-gray-800 rounded-xl p-6 border border-gray-700'>
              ...
              <div className='flex space-x-4'>
                <a
                  href='#'
                  className='w-10 h-10 bg-gray-700 rounded-xl flex items-center justify-center text-gray-300 hover:text-red-400 hover:bg-gray-600 transition-colors'
                >
                  {/* Facebook icon */}
                  <svg
                    className='w-5 h-5'
