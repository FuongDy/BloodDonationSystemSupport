...
const InventoryCard = ({ item, className = '' }) => {  const isExpiringSoon = (expiryDate) => {
    ...
    <Card className={`hover:shadow-lg transition-shadow ${className}`}>
      ...
      <CardContent className="space-y-2">
        ...
        <InfoRow 
          label="Ngày hết hạn" 
          value={
            <span className={isExpiringSoon(item.expiryDate) ? 'text-red-600 font-medium' : ''}>
