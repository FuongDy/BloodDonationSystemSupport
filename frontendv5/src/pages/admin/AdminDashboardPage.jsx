    ...
    <div className='p-6'>
      ...
      <div className='bg-white p-6 rounded-lg shadow-md'>
        ...
        <p className='mt-2 text-gray-600'>
          Đây là trang quản trị của Hệ thống Hỗ trợ Hiến Máu. Bạn có thể quản lý
          người dùng, các thành phần máu, và các thông tin khác từ thanh điều
          hướng bên trái.
        </p>
      ...
      <div className='mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
        ...
        <div className='bg-white p-6 rounded-lg shadow-md'>
          ...
          <p className='text-3xl font-bold text-red-600'>567</p>{' '}
          {/* Thay bằng dữ liệu thật */}
