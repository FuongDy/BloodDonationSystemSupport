...
const ActionButtonGroup = ({ 
  ...
  const containerClass = orientation === 'vertical' ? 'space-y-2' : 'space-x-2 flex';

  return (
    <div className={`${containerClass} ${className}`}>      {actions.map((action, index) => {
        ...
        const buttonProps = {
          ...
          className: action.className || (orientation === 'vertical' ? 'w-full' : ''),
