...
import { Eye, Edit, Trash2, CheckCircle, Clock, User, Calendar } from 'lucide-react';
  ...
  return (
    <div className="bg-white rounded-lg shadow-md border border-gray-200 overflow-hidden hover:shadow-lg transition-shadow">
      ...
      <div className="p-6">
        ...
        </div>        <h3 className="text-lg font-semibold text-gray-900 mb-2 line-clamp-2">
