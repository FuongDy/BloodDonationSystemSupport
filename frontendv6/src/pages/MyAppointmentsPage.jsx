...
const MyAppointmentsPage = () => {
  ...
  const fetchMyAppointments = async (pageNum = 1) => {
    try {
      setIsLoading(true);
      const data = await appointmentService.getMyAppointments({ page: pageNum, size: PAGE_SIZE });
  ...
  const handleConfirmReschedule = async () => {
    ...
    try {
      await appointmentService.requestReschedule(selectedAppointmentId, { reason: rescheduleReason });
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {appointments.length === 0 ? (
          ...
          <>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex items-center justify-between pt-4 border-t">
                      <div className="flex items-center space-x-2 text-sm text-gray-500">
                        ...
                        <span>Tạo lúc: </span>
                        <DateTimeDisplay date={appointment.createdAt} format="short" />
                      </div>
            ...
            <Modal open={showRescheduleDialog} onClose={() => setShowRescheduleDialog(false)}>
              <div className="p-4">
