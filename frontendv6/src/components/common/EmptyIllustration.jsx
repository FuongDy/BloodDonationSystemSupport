...
const EmptyIllustration = ({ 
  ...
  return (
    <div className={`inline-flex items-center justify-center ${sizeClasses[size]} ${config.bg} rounded-full ${className}`}>
      <IconComponentComponent className={`${sizeClasses[size]} ${config.color}`} />
    </div>
  );
};
