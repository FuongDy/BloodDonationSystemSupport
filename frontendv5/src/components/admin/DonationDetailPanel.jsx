...
import { Calendar, User, Phone, Mail, MapPin, FileText, Droplets } from 'lucide-react';
import {
  Card,
  CardContent,
  CardHeader,
      ...
      <CardHeader>
        ...
        <div>
          ...
          <div className='space-y-2'>
            <InfoRow 
              label="Họ tên" 
              value={donation.donor?.fullName || 'N/A'} 
            />
            <InfoRow 
              label="Email" 
        ...
        <div>
          ...
          <div className='space-y-2'>
            ...
            {donation.appointment?.scheduledDate && (
              <InfoRow 
                label="Ngày hẹn" 
                value={<DateTimeDisplay date={donation.appointment.scheduledDate} />} 
              />
            )}
          </div>
        </div>
        ...
        {donation.appointment && (
          <div>
            ...
            <div className='space-y-2'>              <InfoRow 
                label="Địa điểm" 
                value={HOSPITAL_INFO.FULL_NAME} 
              />
              {donation.appointment.address && (
                <InfoRow 
                  label="Địa chỉ" 
                  value={donation.appointment.address} 
                />
              )}
              <InfoRow 
