...
import bloodTypeService from '../services/bloodTypeService'; // <-- FIXED IMPORT
import { userRegistrationSchema } from '../utils/validationSchemas';
import { handleApiError } from '../utils/errorHandler';
import AddressPicker from '../components/common/AddressPicker.jsx'; // Import component bản đồ
...
const RegisterPage = () => {
  ...
  const fetchBloodTypes = useCallback(async () => {
    ...
    try {
      const data = await bloodTypeService.getAll(); // This will now work correctly
