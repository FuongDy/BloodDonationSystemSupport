...
export const useRegister = () => {
    ...
    const handleInputChange = useCallback(
        async(e) => {
            ...
            if (type === 'file') {
                ...
                // Clear validation error for file fields
    ...
    const prepareRegistrationData = (convertedDate) => {
        ...
        if (!formData.frontImage) {
            setValidationErrors(prev => ({
                ...prev,
                frontImage: 'Vui lòng tải lên ảnh mặt trước CCCD/CMND'
            }));
            showNotification('Vui lòng tải lên ảnh mặt trước CCCD/CMND', 'error');
            return null;
        }
        ...
        if (!formData.backImage) {
            setValidationErrors(prev => ({
                ...prev,
                backImage: 'Vui lòng tải lên ảnh mặt sau CCCD/CMND'
            }));
            showNotification('Vui lòng tải lên ảnh mặt sau CCCD/CMND', 'error');
            return null;
        }
