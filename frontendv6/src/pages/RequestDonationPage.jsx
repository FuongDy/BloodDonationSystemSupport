...
const RequestDonationPage = () => {
  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-red-50 via-white to-pink-50 overflow-x-hidden'>
              ...
              <div className='bg-white rounded-2xl shadow-xl p-6 sm:p-8 border border-gray-100'>
                <div className='text-center mb-8'>
                  ...
                  <p className='text-gray-600 text-sm sm:text-base break-words'>
                    Vui lòng điền đầy đủ thông tin để chúng tôi có thể hỗ trợ
                    bạn tốt nhất
                  </p>
                </div>
                    ...
                    <div className='flex items-start'>
                      ...
                      <div>
                        ...
                        <p className='text-sm text-yellow-700 mt-1'>
                          Bạn có thể xem thông tin và quy trình hiến máu. Để đặt
                          lịch hẹn, vui lòng đăng nhập hoặc đăng ký tài khoản.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <form onSubmit={handleSubmit} className='space-y-6'>
                  ...
                  <div className='bg-blue-50 rounded-xl p-6'>
                    ...
                    <div className='mt-3 text-xs text-gray-500'>
                      <p>
                        Tất cả các hoạt động hiến máu sẽ được thực hiện tại địa
                        điểm này.
                      </p>
                    </div>
                  </div>
      ...
      >
        <div>
          Bạn có chắc chắn muốn gửi yêu cầu đăng ký hiến máu với thông tin đã
          nhập?
        </div>
      </Modal>
    </div>
