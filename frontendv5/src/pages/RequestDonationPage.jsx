                ...
                <form onSubmit={handleSubmit} className='space-y-6'>
                  ...
                  <div className='bg-blue-50 rounded-xl p-6'>
                    ...
                    <div className='mt-3 text-xs text-gray-600'>
                      <p className='font-medium mb-1'>Các địa điểm phổ biến:</p>
                      <ul className='space-y-1'>
                        <li className='break-words'>• Trung tâm hiến máu TP.HCM (201 Nguyễn Thị Minh Khai, Q1)</li>
                        <li className='break-words'>• Bệnh viện Chợ Rẫy (201B Nguyễn Chí Thanh, Q5)</li>
                        <li className='break-words'>• Bệnh viện Đại học Y Dược (215 Hồng Bàng, Q5)</li>
                      </ul>
                    </div>
                  </div>
