...
-- ===================================================================================
-- LƯU Ý QUAN TRỌNG: CÁC ID DƯỚI ĐÂY LÀ GIẢ ĐỊNH.
-- BẠN PHẢI THAY THẾ CHÚNG BẰNG CÁC ID THỰC TẾ TỪ DATABASE CỦA BẠN SAU KHI CHẠY BƯỚC 1.
-- Ví dụ ID giả định:
-- Hồng cầu (RBC): O-(1), O+(2), A-(3), A+(4), B-(5), B+(6), AB-(7), AB+(8)
-- Huyết tương (Plasma): O-(9), O+(10), A-(11), A+(12), B-(13), B+(14), AB-(15), AB+(16)
-- Máu toàn phần (WB): O-(17), O+(18), A-(19), A+(20), B-(21), B+(22), AB-(23), AB+(24)
-- ===================================================================================

-- Xóa các quy tắc cũ để tránh trùng lặp (TÙY CHỌN, cẩn thận khi chạy)
-- DELETE FROM blood_type_compatibility;
-- GO

-- ******************************************************
-- ** Phần 1: QUY TẮC TRUYỀN HỒNG CẦU (Red Blood Cells) **
-- ******************************************************

-- Người cho O- (ID 1) + Hồng cầu
INSERT INTO blood_type_compatibility (donor_blood_type_id, recipient_blood_type_id, is_compatible, is_emergency_compatible, notes) VALUES
(1, 1, 1, 1, 'RBC: O- to O-'), (1, 2, 1, 1, 'RBC: O- to O+'),
(1, 3, 1, 1, 'RBC: O- to A-'), (1, 4, 1, 1, 'RBC: O- to A+'),
(1, 5, 1, 1, 'RBC: O- to B-'), (1, 6, 1, 1, 'RBC: O- to B+'),
(1, 7, 1, 1, 'RBC: O- to AB-'),(1, 8, 1, 1, 'RBC: O- to AB+');
GO
-- Người cho O+ (ID 2) + Hồng cầu
INSERT INTO blood_type_compatibility (donor_blood_type_id, recipient_blood_type_id, is_compatible, notes) VALUES
(2, 2, 1, 'RBC: O+ to O+'), (2, 4, 1, 'RBC: O+ to A+'),
(2, 6, 1, 'RBC: O+ to B+'), (2, 8, 1, 'RBC: O+ to AB+');
GO
-- Người cho A- (ID 3) + Hồng cầu
INSERT INTO blood_type_compatibility (donor_blood_type_id, recipient_blood_type_id, is_compatible, notes) VALUES
(3, 3, 1, 'RBC: A- to A-'), (3, 4, 1, 'RBC: A- to A+'),
(3, 7, 1, 'RBC: A- to AB-'), (3, 8, 1, 'RBC: A- to AB+');
GO
-- Người cho A+ (ID 4) + Hồng cầu
INSERT INTO blood_type_compatibility (donor_blood_type_id, recipient_blood_type_id, is_compatible, notes) VALUES
(4, 4, 1, 'RBC: A+ to A+'), (4, 8, 1, 'RBC: A+ to AB+');
GO
-- Người cho B- (ID 5) + Hồng cầu
INSERT INTO blood_type_compatibility (donor_blood_type_id, recipient_blood_type_id, is_compatible, notes) VALUES
(5, 5, 1, 'RBC: B- to B-'), (5, 6, 1, 'RBC: B- to B+'),
(5, 7, 1, 'RBC: B- to AB-'), (5, 8, 1, 'RBC: B- to AB+');
GO
-- Người cho B+ (ID 6) + Hồng cầu
INSERT INTO blood_type_compatibility (donor_blood_type_id, recipient_blood_type_id, is_compatible, notes) VALUES
(6, 6, 1, 'RBC: B+ to B+'), (6, 8, 1, 'RBC: B+ to AB+');
GO
-- Người cho AB- (ID 7) + Hồng cầu
INSERT INTO blood_type_compatibility (donor_blood_type_id, recipient_blood_type_id, is_compatible, notes) VALUES
(7, 7, 1, 'RBC: AB- to AB-'), (7, 8, 1, 'RBC: AB- to AB+');
GO
-- Người cho AB+ (ID 8) + Hồng cầu
INSERT INTO blood_type_compatibility (donor_blood_type_id, recipient_blood_type_id, is_compatible, notes) VALUES
(8, 8, 1, 'RBC: AB+ to AB+');
GO

-- **************************************************
-- ** Phần 2: QUY TẮC TRUYỀN HUYẾT TƯƠNG (Plasma) **
-- **************************************************

-- Người cho O (ID 9, 10) + Huyết tương
INSERT INTO blood_type_compatibility (donor_blood_type_id, recipient_blood_type_id, is_compatible, notes) VALUES
(9, 9, 1, 'Plasma: O- to O-'), (9, 10, 1, 'Plasma: O- to O+'),
(10, 9, 1, 'Plasma: O+ to O-'), (10, 10, 1, 'Plasma: O+ to O+');
GO
-- Người cho A (ID 11, 12) + Huyết tương
INSERT INTO blood_type_compatibility (donor_blood_type_id, recipient_blood_type_id, is_compatible, notes) VALUES
(11, 9, 1, 'Plasma: A- to O-'), (11, 10, 1, 'Plasma: A- to O+'),
(11, 11, 1, 'Plasma: A- to A-'), (11, 12, 1, 'Plasma: A- to A+'),
(12, 9, 1, 'Plasma: A+ to O-'), (12, 10, 1, 'Plasma: A+ to O+'),
(12, 11, 1, 'Plasma: A+ to A-'), (12, 12, 1, 'Plasma: A+ to A+');
GO
-- Người cho B (ID 13, 14) + Huyết tương
INSERT INTO blood_type_compatibility (donor_blood_type_id, recipient_blood_type_id, is_compatible, notes) VALUES
(13, 9, 1, 'Plasma: B- to O-'), (13, 10, 1, 'Plasma: B- to O+'),
(13, 13, 1, 'Plasma: B- to B-'), (13, 14, 1, 'Plasma: B- to B+'),
(14, 9, 1, 'Plasma: B+ to O-'), (14, 10, 1, 'Plasma: B+ to O+'),
(14, 13, 1, 'Plasma: B+ to B-'), (14, 14, 1, 'Plasma: B+ to B+');
GO
-- Người cho AB (ID 15, 16) + Huyết tương
INSERT INTO blood_type_compatibility (donor_blood_type_id, recipient_blood_type_id, is_compatible, is_emergency_compatible, notes) VALUES
(15, 9, 1, 1, 'Plasma: AB- to O-'), (15, 10, 1, 1, 'Plasma: AB- to O+'),
(15, 11, 1, 1, 'Plasma: AB- to A-'), (15, 12, 1, 1, 'Plasma: AB- to A+'),
(15, 13, 1, 1, 'Plasma: AB- to B-'), (15, 14, 1, 1, 'Plasma: AB- to B+'),
(15, 15, 1, 1, 'Plasma: AB- to AB-'),(15, 16, 1, 1, 'Plasma: AB- to AB+'),
(16, 9, 1, 1, 'Plasma: AB+ to O-'), (16, 10, 1, 1, 'Plasma: AB+ to O+'),
(16, 11, 1, 1, 'Plasma: AB+ to A-'), (16, 12, 1, 1, 'Plasma: AB+ to A+'),
(16, 13, 1, 1, 'Plasma: AB+ to B-'), (16, 14, 1, 1, 'Plasma: AB+ to B+'),
(16, 15, 1, 1, 'Plasma: AB+ to AB-'),(16, 16, 1, 1, 'Plasma: AB+ to AB+');
GO

-- ****************************************************
-- ** Phần 3: QUY TẮC TRUYỀN MÁU TOÀN PHẦN (Whole Blood) **
-- ****************************************************
-- Nguyên tắc: Chỉ truyền trùng khớp chính xác nhóm máu ABO và Rh.
...
PRINT 'Đã nạp xong các quy tắc tương thích máu.';
GO
